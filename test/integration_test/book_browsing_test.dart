...
import 'package:ft_transcendence/main.dart' as app;
  ...
  group('Book Browsing Flow Integration Test', () {
    testWidgets('Complete book browsing and search flow',
      ...
      await tester.enterText(
          find.byType(TextField), 'Clean Code');
    ...
    testWidgets('Search with no results', (WidgetTester tester) async {
      ...
      await tester.enterText(
          find.byType(TextField), 'NonExistentBook12345');
      await tester.pumpAndSettle(const Duration(seconds: 2));
    ...
    testWidgets('Navigate between multiple books',
        (WidgetTester tester) async {
      app.main();
      await tester.pumpAndSettle();
      ...
      final firstBookTitle = (tester.widget(find.byType(Text).first) as Text).data;
